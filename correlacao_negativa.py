...
if p_value < alpha:
    print("DECISÃO: Rejeitamos H₀ — Há evidências de correlação linear negativa significativa, há uma significância de 5%.")
else:
    print("DECISÃO: Não rejeitamos H₀ — Não há evidências suficientes de correlação linear, há uma significância de 5%.")
